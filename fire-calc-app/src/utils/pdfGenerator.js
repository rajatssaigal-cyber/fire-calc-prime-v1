...
export const generatePDFReport = (state, results) => {
  ...
  // REVERTED: Removed 'true' to show Rupee symbol
  ...
  autoTable(doc, {
      ...
      body: [[
          ...
          formatINR(state.retirementAnnualExpenses / 12), // Symbol active
          state.inflationRate + '%',
          state.equityReturn + '%'
      ]],
      theme: 'grid',
  ...
  autoTable(doc, {
      ...
      body: keyRows.map(row => [
          ...
          formatCompact(row.balance), // Symbol active
          formatCompact(row.equity),  // Symbol active
          formatCompact(row.stable),  // Symbol active
